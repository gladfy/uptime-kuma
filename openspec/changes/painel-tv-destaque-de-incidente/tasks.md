...
- [x] 8.7 **O painel para de afirmar situação que não leu.** Com o servidor fora, a parede dizia "0 monitores · todos normais" (medido). O estado não era novo, mas quem o alcançava era um humano recarregando — o recarregamento periódico da 8.6 o pôs num temporizador. Agora há `leituraFalhou` separado de `loaded`, um bloco de aviso no lugar do destaque, e marca no cabeçalho quando havia quadro e a leitura falhou. Medido: servidor fora na abertura avisa e não afirma nada; abertura normal com resposta em 900 ms NÃO pisca o aviso; quadro em tela + falha mantém o quadro e marca "falha na última leitura". **Não fecha o 7.4** (o 404 da despublicação continua sendo tratado como falha de rede, com o quadro anterior no ar).
